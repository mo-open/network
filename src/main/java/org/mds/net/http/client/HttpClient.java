...
import org.mds.net.http.client.HttpClientBuilder.ChannelOptionSetting;
...
public final class HttpClient {
    ...
    private synchronized Bootstrap start() {
        if (bootstrap == null) {
            ...
            bootstrap.handler(new Initializer(new MessageHandlerImpl(followRedirects, this),
                    false, maxChunkSize, maxInitialLineLength, maxHeadersSize, compress));
    ...
    private synchronized Bootstrap startSsl() {
        if (bootstrapSsl == null) {
            ...
            bootstrapSsl.handler(new Initializer(new MessageHandlerImpl(followRedirects, this),
                    true, maxChunkSize, maxInitialLineLength, maxHeadersSize, compress));
